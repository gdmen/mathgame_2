...
const ProblemTypesTabView = ({ token, url, user, settings, advanceSettings }) => {
...
const VideosTabView = ({ token, url, user, advanceSettings }) => {
...
const PinTabView = ({ token, url, user, advanceSettings }) => {
...
const SettingsView = ({ token, url, user, settings }) => {
  ...
  const advanceSettings = function() {
  ...
  return (<div id="setup">
    ...
    { (activeTab === "Choose Problems") && <div className="tab-content"><ProblemTypesTabView token={token} url={url} user={user} settings={settings} advanceSettings={advanceSettings}/></div> }
    { (activeTab === "Add Videos") && <div className="tab-content"><VideosTabView token={token} url={url} user={user} advanceSettings={advanceSettings}/></div> }
    { (activeTab === "Set Parent Pin") && <div className="tab-content"><PinTabView token={token} url={url} user={user} advanceSettings={advanceSettings}/></div> }
