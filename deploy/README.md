...
sudo cp deploy/mathgame-watchdog.service /etc/systemd/system
sudo cp deploy/mathgame-watchdog.timer /etc/systemd/system
...
sudo systemctl enable --now mathgame-watchdog.timer
...
journalctl -u mathgame-watchdog -b -f
