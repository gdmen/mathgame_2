...
//
// Topics whose pool is thin get a proportionally larger lottery weight, so
// hard-to-generate bits (WORD, DECIMALS, PEMDAS, PERCENTAGES) keep
// appearing without starving everything else or hard-forcing any one bit.
package api
