...
// Privileged surfaces gate on RequireAdmin. See #253.
package api
...
// /api/v1/admin group a first inhabitant for operator-only surfaces (e.g. the
// #35 calibration page) to register alongside.
