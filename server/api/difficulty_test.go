...
func TestComputeProblemDifficulty_AnchorTable(t *testing.T) {
	...
	cases := []struct {
		...
		// Exponents are excluded from the alphabet (#228): legacy fallback,
		// no exponent weight (v0.1's opWeight-4.0 branch removed).
...
// alphabet (#228); such expressions take the legacy fallback path and carry
// no exponent weight (the v0.1 opWeight-4.0 branch is removed).
